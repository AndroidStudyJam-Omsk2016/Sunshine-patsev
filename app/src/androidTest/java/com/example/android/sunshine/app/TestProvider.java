...
public class TestProvider extends AndroidTestCase {
    ...
    public void testProviderRegistry() {
        ...
        ComponentName componentName = new ComponentName(mContext.getPackageName(),
                com.example.android.sunshine.app.data.WeatherProvider.class.getName());
        try {
            ...
            assertEquals("Error: WeatherProvider registered with authority: " + providerInfo.authority +
                            " instead of authority: " + com.example.android.sunshine.app.data.WeatherContract.CONTENT_AUTHORITY,
                    providerInfo.authority, com.example.android.sunshine.app.data.WeatherContract.CONTENT_AUTHORITY);
    ...
    public void testBasicWeatherQuery() {
        ...
        com.example.android.sunshine.app.data.WeatherDbHelper dbHelper = new WeatherDbHelper(mContext);
        SQLiteDatabase db = dbHelper.getWritableDatabase();

        ContentValues testValues = com.example.android.sunshine.app.data.TestUtilities.createNorthPoleLocationValues();
        long locationRowId = com.example.android.sunshine.app.data.TestUtilities.insertNorthPoleLocationValues(mContext);
        ...
        com.example.android.sunshine.app.data.TestUtilities.validateCursor("testBasicWeatherQuery", weatherCursor, weatherValues);
    }
    ...
    public void testBasicLocationQueries() {
        ...
        // Make sure we get the correct cursor out of the database
        com.example.android.sunshine.app.data.TestUtilities.validateCursor("testBasicLocationQueries, location query", locationCursor, testValues);
    ...
    public void testUpdateLocation() {
        ...
        ContentValues values = com.example.android.sunshine.app.data.TestUtilities.createNorthPoleLocationValues();
    ...
    public void testInsertReadProvider() {
        ...
        weatherCursor = mContext.getContentResolver().query(
                WeatherEntry.buildWeatherLocationWithStartDate(
                        com.example.android.sunshine.app.data.TestUtilities.TEST_LOCATION, TestUtilities.TEST_DATE),
                null, // leaving "columns" null just returns all the columns.
                null, // cols for "where" clause
                null, // values for "where" clause
                null  // sort order
        ...
        weatherCursor = mContext.getContentResolver().query(
                WeatherEntry.buildWeatherLocationWithDate(com.example.android.sunshine.app.data.TestUtilities.TEST_LOCATION, TestUtilities.TEST_DATE),
                null,
                null,
                null,
                null
    ...
    static ContentValues[] createBulkInsertWeatherValues(long locationRowId) {
        ...
        for ( int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++, currentTestDate+= millisecondsInADay ) {
            ...
            weatherValues.put(com.example.android.sunshine.app.data.WeatherContract.WeatherEntry.COLUMN_DATE, currentTestDate);
            weatherValues.put(com.example.android.sunshine.app.data.WeatherContract.WeatherEntry.COLUMN_DEGREES, 1.1);
            weatherValues.put(com.example.android.sunshine.app.data.WeatherContract.WeatherEntry.COLUMN_HUMIDITY, 1.2 + 0.01 * (float) i);
            weatherValues.put(com.example.android.sunshine.app.data.WeatherContract.WeatherEntry.COLUMN_PRESSURE, 1.3 - 0.01 * (float) i);
            weatherValues.put(com.example.android.sunshine.app.data.WeatherContract.WeatherEntry.COLUMN_MAX_TEMP, 75 + i);
            weatherValues.put(com.example.android.sunshine.app.data.WeatherContract.WeatherEntry.COLUMN_MIN_TEMP, 65 - i);
            weatherValues.put(com.example.android.sunshine.app.data.WeatherContract.WeatherEntry.COLUMN_SHORT_DESC, "Asteroids");
            weatherValues.put(com.example.android.sunshine.app.data.WeatherContract.WeatherEntry.COLUMN_WIND_SPEED, 5.5 + 0.2 * (float) i);
